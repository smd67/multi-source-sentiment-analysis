...
export default {
    ...
    methods: {
      ...
      async fetchDataSingleThreaded() {
        var apiUrl = 'http://3.21.129.197:8005/get-logo/'; // Replace with your actual API endpoint
        const config = {
            headers: {
    ...
    async fetchDataMultiThreaded() {
        var apiUrl = 'http://3.21.129.197:8005/get-all-data/'; 
        const config = {
            headers: {
                'Content-Type': 'application/json'
            }
