...
export default {
    ...
    methods: {
      ...
      async fetchDataSingleThreaded() {
        var apiUrl = 'http://18.217.148.82:8005/get-logo/'; // Replace with your actual API endpoint
        const config = {
            headers: {
    ...
    async fetchDataMultiThreaded() {
        var apiUrl = 'http://18.217.148.82:8005/get-all-data/'; 
        const config = {
            headers: {
                'Content-Type': 'application/json'
            }
