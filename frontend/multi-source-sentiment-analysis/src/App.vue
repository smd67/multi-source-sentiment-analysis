...
export default {
    ...
    methods: {
      ...
      async fetchDataSingleThreaded() {
        var apiUrl = 'http://3.21.127.150:8005/get-logo/'; // Replace with your actual API endpoint
        const config = {
            headers: {
    ...
    async fetchDataMultiThreaded() {
        var apiUrl = 'http://3.21.127.150:8005/get-all-data/'; 
        const config = {
            headers: {
                'Content-Type': 'application/json'
            }
